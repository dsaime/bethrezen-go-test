...
import (
	...
	"newsapi/internal/usecases/chats/update_name"
...
// UsecasesForUpdateName_UpdateName_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateNews'
...
func (_e *UsecasesForUpdateName_Expecter) UpdateName(in interface{}) *UsecasesForUpdateName_UpdateName_Call {
	return &UsecasesForUpdateName_UpdateName_Call{Call: _e.mock.On("UpdateNews", in)}
}
