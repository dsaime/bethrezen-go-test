...
import (
	...
	mockRegisterHandler "newsapi/internal/controller/http2/register_handler/mocks"
	"newsapi/internal/domain/sessionn"
	"newsapi/internal/domain/userr"
	oauthAuthorize "newsapi/internal/usecases/users/oauth/oauth_authorize"
	oauthComplete "newsapi/internal/usecases/users/oauth/oauth_complete"
)
